...
class SkinCavendish extends SkinTemplate {
    ...
    function setupSkinUserCss( OutputPage $out ) {
		...
		global $cavendishLogoURL, $cavendishLogoWidth, $cavendishLogoHeight, $cavendishLogoMargin, $cavendishSiteWith, $cavendishExtensionCSS;
		...
		if(isset($cavendishLogoMargin)) {
			$cavendishAdditional = 'margin-top:'.$cavendishLogoMargin.'px;';
		}
		...
		$headStyle = '#header h6 a { background: transparent url("'.$cavendishLogoURL.'") no-repeat; width:'.$cavendishLogoWidth.'px;height:'.$cavendishLogoHeight.'px;'.$cavendishAdditional.'}'.$cavendishglobalWrapper;
		if ( $verint > 15 ) {
...
class CavendishTemplate extends MonoBookTemplate {
	 ...
	 */
	function execute() {
		global $wgRequest, $verint, $header15;
		$styleversion = '1.3.3';
